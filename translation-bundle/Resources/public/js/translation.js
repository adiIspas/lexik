...
app.factory('translationApiManager', ['$http', function ($http) {
    return {
        ...
        exportChanges: function () {
            return $http.get(translationCfg.url.exportChanges, {headers: {'X-Requested-With': 'XMLHttpRequest'}});
        },

        importTranslations: function () {
            return $http.get(translationCfg.url.importTranslations, {headers: {'X-Requested-With': 'XMLHttpRequest'}});
        },
...
app.controller('TranslationController', [
    ...
    function ($scope, $location, $anchorScroll, sharedMessage, tableParamsManager, translationApiManager) {
        ...
        // import translations
        $scope.importTranslations = function () {
            translationApiManager
                .importTranslations()
                .success(function (responseData) {
                    sharedMessage.set('success', 'ok-circle', responseData.message);
